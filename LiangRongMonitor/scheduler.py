...
class MarginScheduler:
    ...
    def run_workflow(self):
        ...
        try:
            ...
            logger.info(f"执行时间: {logger.handlers[0].formatter.formatTime(logger.handlers[0], None)}")
            logger.info("="*80)
...
if __name__ == '__main__':
    ...
    print("="*80)
    print(f"启动时间: {logger.handlers[0].formatter.formatTime(logger.handlers[0], None)}")
    print("="*80)
    print("自选股监控:")
