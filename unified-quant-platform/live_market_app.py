...
# -*- coding: utf-8 -*-
"""
OpenClaw 统一量化交易平台 v5.4 - A股实盘数据
直接对接AKShare实盘数据，实时获取
"""
...
def get_market_realtime_akshare():
    """
    使用AKShare获取市场整体数据
...
def analyze_market_realtime():
    ...
    """
    # 获取市场数据
    market_data = get_market_realtime_akshare()
...
<head>
    ...
    <title>OpenClaw 统一量化交易平台 v5.4</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="data-status">
            <h3>✅ A股实盘数据</h3>
            <p>直接对接AKShare，实时获取A股市场数据，无需缓存，实时更新！</p>
        </div>
        ...
        <div id="realtime" class="section active">
            ...
            <div class="loading" id="realtime-loading">正在获取实盘数据，请稍候...</div>
        ...
        <div id="market" class="section">
            ...
            <div class="loading" id="market-loading">正在扫描全市场，请稍候...</div>
        ...
        <div id="chip" class="section">
            ...
            <div class="loading" id="chip-loading">正在获取实盘数据，请稍候...</div>
...
def market():
    """市场分析API"""
    return jsonify(analyze_market_realtime())
